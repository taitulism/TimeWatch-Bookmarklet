if (window.location.hostname !== 'checkin.timewatch.co.il') window.location.href = 'https://checkin.timewatch.co.il';

const trs = jQuery('.tr td:nth-child(13)');

const mapped = trs.map(function (i, td) {
